...
# Fixation
1.	15 ml FSW (0.2 microns filtered seawater) in a 50 ml tube (for small fragments).
...
5.	The resulting concentration is indeed 5% (0.3 ml 1M solution in 15 ml of FSW (stack solution:   for 50 ml       10.165 gr Mgcl 2·6H2O
6.	Remove the FSW from the tube.
7.	Under a hood Submerge coral sample in Bouin’s fixative (15 parts picric acid : 5 parts formalin: 1 part acetic acid).
8.	 Leave at 4°C 2 hr. at room temperature.
9.	For extended storage, store in 70% sterile ethanol, or leave in PBS for short storage of 2-3 days.
10.	Rinse the samples three times with PBS X3, 10 minutes each.
11.	Keep one intact nubbin as a negative control.
# Decalcification
...
4.	leave samples in the solution (with cup not fully sealed for gas release) until the skeleton is completely dissolved.
5.	Confirm full decalcification by visual disappearance of the skeleton and preserved tissue structure.
6.	Transfer decalcified tissue into a cassete, mark the sample name on it using a crayon.
7.	Wash X3 with PBS in RT, 15 min each.
8.	Start dehydration immediately or store in 70% methyl alcohol until further processing.
9.	
...
2.	Pass samples through an ethanol series (50% 70%, 90%, 100%). If the tissue is more than 2mm thick extend the last step (100%) to 30min.
3.	Clear the tissue through a series of graded butanol (diluted with ethanol) 50%, 75%, and 100%, 30 min each (the last one can be extended to 1 h).
